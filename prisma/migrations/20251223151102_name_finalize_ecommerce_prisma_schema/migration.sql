...
-- CreateEnum
CREATE TYPE "PaymentMethod" AS ENUM ('SSL_COMMERZ', 'STRIPE', 'CASH_ON_DELIVERY');
...
-- CreateIndex
CREATE UNIQUE INDEX "SSLCommerzTransaction_orderId_key" ON "SSLCommerzTransaction"("orderId");
