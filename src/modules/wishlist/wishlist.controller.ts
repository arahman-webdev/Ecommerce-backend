...
const addToWishlist = async (
  ...
  try {
    ...
    const result = await ProductWishlistService.addToWishlist(
      userId,
      productId
    );
...
const removeFromWishlist = async (
  ...
  try {
    ...
    const result = await ProductWishlistService.removeFromWishlist(
      userId,
      productId
    );
...
export const ProductWishlistController = {
  addToWishlist,
  removeFromWishlist,
  getWishlist,
};
